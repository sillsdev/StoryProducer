...
public class BloomLibraryActivity extends AppCompatActivity implements MessageReceiver {
//    public abstract class BaseActivity extends AppCompatActivity {
    ...
    static BloomLibraryActivity mBloomActivity = null;
...
//        mBrowser.addJavascriptInterface(mAppInterface, "ParentProxy");
        ...
        try {
            ...
            if (BuildConfig.DEBUG) // Using production website for release and continuous builds
