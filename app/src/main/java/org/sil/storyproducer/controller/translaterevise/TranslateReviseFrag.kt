        ...
        if (slideNumber == 0) {
            ...
            mPopupHelpUtils?.addPopupHelpItem(
                ...
                R.string.help_translate_enter_title, R.string.help_translate_enter_body, {
                    Workspace.activeStory.slides.firstOrNull {
                        it.slideType == SlideType.FRONTCOVER && it.translatedContent.isNotEmpty() } != null
                })
            mPopupHelpUtils?.addPopupHelpItem(
                ...
                R.string.help_translate_record_title, R.string.help_translate_record_body, {
                    Workspace.activeStory.slides.firstOrNull {
                        it.slideType == SlideType.FRONTCOVER && it.translateReviseAudioFiles.isNotEmpty() } != null
                })
            mPopupHelpUtils?.addPopupHelpItem(
                    R.id.seek_bar,
                    86, 90,
            ...
            mPopupHelpUtils?.addPopupHelpItem(
                ...
                R.string.help_translate_record_slide_title, R.string.help_translate_record_slide_body, {
                    Workspace.activeStory.slides.firstOrNull { it.slideType == SlideType.NUMBEREDPAGE && it.translateReviseAudioFiles.isNotEmpty() } != null
                })
            mPopupHelpUtils?.addPopupHelpItem(
