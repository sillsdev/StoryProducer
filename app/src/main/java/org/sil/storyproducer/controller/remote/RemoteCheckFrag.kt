...
class RemoteCheckFrag : Fragment() {
    ...
    private fun sendMessage() {
        ...
        val req = object : paramStringRequest(Request.Method.POST, sendMessagesUrl, js, Response.Listener { response ->
    ...
    private fun getMessages() {
        ...
        val req = object : StringRequest(Request.Method.POST, getMessagesUrl, Response.Listener { response ->
