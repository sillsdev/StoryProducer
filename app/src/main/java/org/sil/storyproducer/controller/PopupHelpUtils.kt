...
class PopupItem(val anchorViewId: Int,
                ...
                val isParentTaskAccomplished: (() -> Boolean)? = null) {
}
                     ...
                     private val helpSeriesIndex: Int = 0)  // used to allow two or more help sequences for this fragment/activity
{
    ...
    fun addPopupHelpItem(anchorViewId: Int,
                    ...
                    isParentTaskAccomplished: (() -> Boolean)? = null) {

        val newPopup = PopupItem(anchorViewId, percentX, percentY, titleResId, bodyResId, isTaskAccomplished, isParentTaskAccomplished)
    ...
    fun showNextPopupHelp() :Boolean {
        ...
        if ((popupItem.isTaskAccomplished != null) && !popupItem.isTaskAccomplished.invoke())
             showNextGrayed = true
        if (!showNextGrayed && (popupItem.isParentTaskAccomplished != null && !popupItem.isParentTaskAccomplished.invoke()))
            showNextGrayed = true
    ...
    class CustomPopupWindow(
        ...
        private fun updateUI() {
            ...
            if (!doneIt && popupItem.isTaskAccomplished != null && popupItem.isTaskAccomplished.invoke())
                doneIt = true
            if (!doneIt && popupItem.isParentTaskAccomplished != null && popupItem.isParentTaskAccomplished.invoke())
                doneIt = true
