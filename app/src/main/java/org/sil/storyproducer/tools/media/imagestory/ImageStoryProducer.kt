package org.sil.storyproducer.tools.media.imagestory
...
import org.sil.storyproducer.tools.media.imagestory.graphics.KenBurnsEffect
...
class SlideProducer(override var parent:FinalizeActivity): Producer, Thread(), Closeable {
    ...
    private val video3gpPath: String get(){return File(videoRelPath).nameWithoutExtension + VIDEO_3GP_EXT }
...
//        watchProgress()
    ...
    companion object {
        private const val TAG = "AutoStoryMaker"

        private const val SLIDE_CROSS_FADE_US: Long = 750000
        private const val AUDIO_TRANSITION_US: Long = 500000


        private const val VIDEO_MP4_EXT = ".mp4"
        private const val VIDEO_MP4_CODEC = MediaFormat.MIMETYPE_VIDEO_AVC
        private const val VIDEO_MP4_COLOR = MediaCodecInfo.CodecCapabilities.COLOR_FormatSurface
        private const val VIDEO_MP4_WIDTH = 768
        private const val VIDEO_MP4_HEIGHT = 576
        private const val VIDEO_MP4_BITRATE = 5000000
        private const val VIDEO_MP4_FRAMERATE = 30
        private const val VIDEO_MP4_IFRAME_INTERVAL = 8           // 5 second between I-frames

        private const val VIDEO_3GP_EXT = ".3gp"
        private const val VIDEO_3GP_CODEC = "h263"
        private const val VIDEO_3GP_WIDTH = 176
        private const val VIDEO_3GP_HEIGHT = 144
        private const val VIDEO_3GP_AUDIO = "aac"
        private const val VIDEO_3GP_BITRATE = 1000000
        private const val VIDEO_3GP_FRAMERATE = 15

        // parameters for the audio encoder
        private const val AUDIO_MIME_TYPE = "audio/mp4a-latm" //MediaFormat.MIMETYPE_AUDIO_AAC;
