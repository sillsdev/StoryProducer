...
class ReviewAdjustPhaseBase(sharedBase: SharedBase) : PlayerPhaseTestBase(sharedBase) {
    ...
    fun test_shouldBeAbleToAdjustAudio() {
        ...
        val leftArrow = Espresso.onView(CoreMatchers.allOf(ViewMatchers.withId(R.id.film_studio_narration_move_left), isDisplayed()))
        val rightArrow = Espresso.onView(CoreMatchers.allOf(ViewMatchers.withId(R.id.film_studio_narration_move_right), isDisplayed()))
    ...
    fun test_moveAudioWhilePlaying() {
        ...
        val leftArrow = Espresso.onView(CoreMatchers.allOf(ViewMatchers.withId(R.id.film_studio_narration_move_left)))
        val rightArrow = Espresso.onView(CoreMatchers.allOf(ViewMatchers.withId(R.id.film_studio_narration_move_right)))
    ...
    private fun helper_setupReviewAdjust() {
